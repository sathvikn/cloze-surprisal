...
def permutation_test(err_1, err_2, n_iter=10000, n_tails=2, mode='loss', nested=False, verbose=False):
    ...
    :param err_1: ``numpy`` vector; first error/loss vector. "smaller model"
    :param err_2: ``numpy`` vector; second error/loss vector. "larger model"
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-t', '--n_tails', type=int, default=1, help='Number of tails in the test (1 or 2).')
    argparser.add_argument('-m', '--mode', type=str, default='loglik', help='Type of test statistic used. One of ["loss", "loglik"].')
    ...
    a_data = pd.read_csv(paths[0], header=None).values
    b_data = pd.read_csv(paths[1], header=None).values
